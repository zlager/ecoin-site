...
*/
define( 'NextScripts_SNAP_Version' , '4.1.4' ); define( 'NextScripts_SNAP_Version_Date' , 'Feb 8, 2018' ); require_once "inc/nxs_functions_wp.php"; if(!defined( 'NXSSNAP_BASENAME' ) ) define( 'NXSSNAP_BASENAME', plugin_basename( __FILE__ ) );
