...
if (!class_exists("nxs_snapClassDL")) { class nxs_snapClassDL extends nxs_snapClassNT { 
  var $ntInfo = array('code'=>'DL', 'lcode'=>'dl', 'name'=>'Delicious', 'defNName'=>'uName', 'tstReq' => false, 'instrURL'=>'https://www.nextscripts.com/setup-installation-delicious-social-networks-auto-poster-wordpress/');    
