<table class="form-table" style="width: auto;">
	...
	<tr>
		<th scope="row" class="col-w-1perc">
			...
			<i class="fa fa-question supsystic-tooltip" title="<?php echo esc_html(sprintf(__('Hide standard video player controls. For vimeo videos - you need to change this in your vide settings, check <a href="%s" target="_blank">this FAQ</a>.', PPS_LANG_CODE), 'https://vimeo.com/help/faq/sharing-videos/embedding-videos'))?>"></i>
		</th>
		<td class="col-w-1perc">
