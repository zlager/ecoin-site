...
if ( ! defined( 'WPINC' ) ) {
	 ...
	 * mobile
	 */
	$mobiile1 = get_option('qam_mobile1');
	$mobiile2 = get_option('qam_mobile2');
	$mobiile3 = get_option('qam_mobile3');
	$mobiile4 = get_option('qam_mobile4');
	$mobiile5 = get_option('qam_mobile5');

	$mobiile6[0] = get_option('qam_mobile60');
	$mobiile6[1] = get_option('qam_mobile61');
	$mobiile6[2] = get_option('qam_mobile62');
	$mobiile7 = get_option('qam_mobile7');

	$pcc1 = get_option('qam_pcc1');
	$pcc2 = get_option('qam_pcc2');
	$pcc3 = get_option('qam_pcc3');
	$pcc4 = get_option('qam_pcc4');
	$pcc5 = get_option('qam_pcc5');

	$pcc6[0] = get_option('qam_pcc60');
	$pcc6[1] = get_option('qam_pcc61');
	$pcc6[2] = get_option('qam_pcc62');
	$pcc7 = get_option('qam_pcc7');
...
<script type="text/javascript">
	function defaultoptions() {
		...
		document.getElementById("mobile1").checked = <?php echo(truefalse($QData['Default']['mobile1'])) ?>;
		document.getElementById("mobile2").checked = <?php echo(truefalse($QData['Default']['mobile2'])) ?>;
		document.getElementById("mobile3").checked = <?php echo(truefalse($QData['Default']['mobile3'])) ?>;
		document.getElementById("mobile4").checked = <?php echo(truefalse($QData['Default']['mobile4'])) ?>;
		document.getElementById("mobile5").checked = <?php echo(truefalse($QData['Default']['mobile5'])) ?>;
		document.getElementById("mobile60").checked = <?php echo(truefalse($QData['Default']['mobile60'])) ?>;
		document.getElementById("mobile61").checked = <?php echo(truefalse($QData['Default']['mobile61'])) ?>;
		document.getElementById("mobile62").checked = <?php echo(truefalse($QData['Default']['mobile62'])) ?>;
		document.getElementById("mobile7").checked = <?php echo(truefalse($QData['Default']['mobile7'])) ?>;

		document.getElementById("pcc1").checked = <?php echo(truefalse($QData['Default']['pcc1'])) ?>;
		document.getElementById("pcc2").checked = <?php echo(truefalse($QData['Default']['pcc2'])) ?>;
		document.getElementById("pcc3").checked = <?php echo(truefalse($QData['Default']['pcc3'])) ?>;
		document.getElementById("pcc4").checked = <?php echo(truefalse($QData['Default']['pcc4'])) ?>;
		document.getElementById("pcc5").checked = <?php echo(truefalse($QData['Default']['pcc5'])) ?>;
		document.getElementById("pcc60").checked = <?php echo(truefalse($QData['Default']['pcc60'])) ?>;
		document.getElementById("pcc61").checked = <?php echo(truefalse($QData['Default']['pcc61'])) ?>;
		document.getElementById("pcc62").checked = <?php echo(truefalse($QData['Default']['pcc62'])) ?>;
		document.getElementById("pcc7").checked = <?php echo(truefalse($QData['Default']['pcc7'])) ?>;
	...
	function qam_checkinfo1(selnme,ts) {
		document.getElementById(selnme).disabled=!ts.checked;
	}
	function qam_checkinfo2(ts,selnm1,selnm2,selnm3,selnm4) {
	...
	function qam_deftcheckinfo() {
		qam_checkinfo1('BegnRnd',document.getElementById('BegnAds'));
		qam_checkinfo1('MiddRnd',document.getElementById('MiddAds'));
		qam_checkinfo1('EndiRnd',document.getElementById('EndiAds'));
		qam_checkinfo1('MoreRnd',document.getElementById('MoreAds'));
		qam_checkinfo1('LapaRnd',document.getElementById('LapaAds'));
		for (i=1;i<=3;i++) {
			qam_checkinfo2(document.getElementById('Par'+i+'Ads'),'Par'+i+'Rnd','Par'+i+'Nup','Par'+i+'Con');
		}
		qam_checkinfo2(document.getElementById('Img1Ads'),'Img1Rnd','Img1Nup','Img1Con');
	}
</script>

<div class="wrap">
<h2>Quick Adsense Mobile <?php _e('Setting'); ?> <span style="font-size:9pt;font-style:italic">( Version <?php echo($QData['Version']); ?> )</span></h2>
...
<form method="post" action="options.php">
	...
	<?php _e('<a href="https://pluginmarket.net/banner/mienlace.php"><img src="https://pluginmarket.net/banner/mibanner.png"></a>
 </br>
	Welcome to Quick Adsense Mobile, this version lets choose which ads you want to show in mobile version or PC version <br>
  If you check in "show in mobile" the ads will be show in mobile phones, tablets ...  If you check in  "show in PC" the ads will be show in PCs.<br>
	<br>
	If you have any suggestion you can put on contact with us <a href="https://pluginmarket.net">here</a>, enjoy!<br>
	...
	<tr valign="top">
		...
		<td>
				<input type="checkbox" id="BegnAds" name="BegnAds" value="true" <?php if($ra1){echo('checked');} ?> onchange="qam_checkinfo1('BegnRnd',this)" /> <?php _e('Assign') ; ?> <select id="BegnRnd" name="BegnRnd" onchange="qam_selectinfo(this)">
					...
					<?php } ?></select><?php _e(' show in <b>PC</b> ') ?><input type="checkbox" id="qam_pcc1" name="qam_pcc1" value="false" <?php if($pcc1){echo 'checked';} ?>  >  <?php _e(' show in <b>mobile</b> ') ?><input type="checkbox" id="qam_mobile1" name="qam_mobile1" value="false" <?php if($mobiile1){echo 'checked';} ?>  >  <?php _e('to <b>Beginning of Post</b>') ?><br/>
				<input type="checkbox" id="MiddAds" name="MiddAds" value="false" <?php if($rm1){echo('checked');} ?> onchange="qam_checkinfo1('MiddRnd',this)" /> <?php _e('Assign') ; ?> <select id="MiddRnd" name="MiddRnd" onchange="qam_selectinfo(this)">
					<?php for ($i=0;$i<=$QData['Ads'];$i++) { ?>
						<option id="OptMidd<?php echo $i; ?>" value="<?php echo $i; ?>" <?php if($rm2==(string)$i){echo('selected');} ?>><?php _e(($i==0)?'Random Ads':'Ads'.$i) ; ?></option>
					<?php } ?></select><?php _e(' show in <b>PC</b> ') ?><input type="checkbox" id="qam_pcc2" name="qam_pcc2" value="false" <?php if($pcc2){echo 'checked';} ?>  ><?php _e(' show in <b>mobile</b> ') ?><input type="checkbox" id="qam_mobile2" name="qam_mobile2" value="false" <?php if($mobiile2){echo 'checked';} ?> >  <?php _e('to <b>Middle of Post</b>') ?><br/>
				<input type="checkbox" id="EndiAds" name="EndiAds" value="false" <?php if($rb1){echo('checked');} ?> onchange="qam_checkinfo1('EndiRnd',this)" /> <?php _e('Assign') ; ?> <select id="EndiRnd" name="EndiRnd" onchange="qam_selectinfo(this)">
					<?php for ($i=0;$i<=$QData['Ads'];$i++) { ?>
						<option id="OptEndi<?php echo $i; ?>" value="<?php echo $i; ?>" <?php if($rb2==(string)$i){echo('selected');} ?>><?php _e(($i==0)?'Random Ads':'Ads'.$i) ; ?></option>
					<?php } ?></select><?php _e(' show in <b>PC</b> ') ?><input type="checkbox" id="qam_pcc3" name="qam_pcc3" value="false" <?php if($pcc3){echo 'checked';} ?>  ><?php _e(' show in <b>mobile</b> ') ?><input type="checkbox" id="qam_mobile3" name="qam_mobile3" value="false" <?php if($mobiile3){echo 'checked';} ?>  >  <?php _e('to <b>End of Post</b>') ?><br/>
				<input type="checkbox" id="MoreAds" name="MoreAds" value="false" <?php if($rr1){echo('checked');} ?> onchange="qam_checkinfo1('MoreRnd',this)" /> <?php _e('Assign') ; ?> <select id="MoreRnd" name="MoreRnd" onchange="qam_selectinfo(this)">
					<?php for ($i=0;$i<=$QData['Ads'];$i++) { ?>
						<option id="OptMore<?php echo $i; ?>" value="<?php echo $i; ?>" <?php if($rr2==(string)$i){echo('selected');} ?>><?php _e(($i==0)?'Random Ads':'Ads'.$i) ; ?></option>
					<?php } ?></select><?php _e(' show in <b>PC</b> ') ?><input type="checkbox" id="qam_pcc4" name="qam_pcc4" value="false" <?php if($pcc4){echo 'checked';} ?>  ><?php _e(' show in <b>mobile</b> ') ?><input type="checkbox" id="qam_mobile4" name="qam_mobile4" value="false" <?php if($mobiile4){echo 'checked';} ?> >  <?php _e('right after <b>the') ?> <span style="font-family:Courier New,Courier,Fixed;">&lt;!--more--&gt;</span> <?php _e('tag') ?></b><br/>
				<input type="checkbox" id="LapaAds" name="LapaAds" value="false" <?php if($rp1){echo('checked');} ?> onchange="qam_checkinfo1('LapaRnd',this)" /> <?php _e('Assign') ; ?> <select id="LapaRnd" name="LapaRnd" onchange="qam_selectinfo(this)">
					<?php for ($i=0;$i<=$QData['Ads'];$i++) { ?>
						<option id="OptLapa<?php echo $i; ?>" value="<?php echo $i; ?>" <?php if($rp2==(string)$i){echo('selected');} ?>><?php _e(($i==0)?'Random Ads':'Ads'.$i) ; ?></option>
					<?php } ?></select><?php _e(' show in <b>PC</b> ') ?><input type="checkbox" id="qam_pcc5" name="qam_pcc5" value="false" <?php if($pcc5){echo 'checked';} ?>  ><?php _e(' show in <b>mobile</b> ') ?><input type="checkbox" id="qam_mobile5" name="qam_mobile5" value="false" <?php if($mobiile5){echo 'checked';} ?>  >  <?php _e('right before <b>the last Paragraph</b>') ?><span style="color:#a00;"> <b>(New)</b></span><br/>
				<?php for ($j=1;$j<=$rc;$j++) { ?>
					<input type="checkbox" id="Par<?php echo $j; ?>Ads" name="Par<?php echo $j; ?>Ads" value="false" <?php if($rc1[$j]){echo('checked');} ?> onchange="qam_checkinfo2(this,'Par<?php echo $j; ?>Rnd','Par<?php echo $j; ?>Nup','Par<?php echo $j; ?>Con')" /> <?php _e('Assign') ; ?> <select id="Par<?php echo $j; ?>Rnd" name="Par<?php echo $j; ?>Rnd" onchange="qam_selectinfo(this)">
						<?php for ($i=0;$i<=$QData['Ads'];$i++) { ?>
						...
						<?php } ?></select><?php _e(' show in <b>PC</b> ') ?><input type="checkbox" id="qam_pcc6<?php echo $j-1; ?>" name="qam_pcc6<?php echo $j-1; ?>" value="false" <?php  if($pcc6[($j-1)]){echo 'checked';} ?>  >   <?php _e(' show in <b>mobile</b> ') ?><input type="checkbox" id="qam_mobile6<?php echo $j-1; ?>" name="qam_mobile6<?php echo $j-1; ?>" value="false" <?php  if($mobiile6[($j-1)]){echo 'checked';} ?>  >  <?php _e('<b>After Paragraph</b> ') ?> <select id="Par<?php echo $j; ?>Nup" name="Par<?php echo $j; ?>Nup">
							<?php for ($i=1;$i<=50;$i++) { ?>
				...
				<?php } ?>
				<input type="checkbox" id="Img1Ads" name="Img1Ads" value="false" <?php if($rd1){echo('checked');} ?> onchange="qam_checkinfo2(this,'Img1Rnd','Img1Nup','Img1Con')" /> <?php _e('Assign') ; ?> <select id="Img1Rnd" name="Img1Rnd" onchange="qam_selectinfo(this)">
					<?php for ($i=0;$i<=$QData['Ads'];$i++) { ?>
						<option id="OptImg1<?php echo $i; ?>" value="<?php echo $i; ?>" <?php if($rd2==(string)$i){echo('selected');} ?>><?php _e(($i==0)?'Random Ads':'Ads'.$i) ; ?></option>
					<?php } ?></select><?php _e(' show in <b>PC</b> ') ?><input type="checkbox" id="qam_pcc7" name="qam_pcc7" value="false" <?php if($pcc7){echo 'checked';} ?>  ><?php _e(' show in <b>mobile</b> ') ?><input type="checkbox" id="qam_mobile7" name="qam_mobile7" value="false" <?php if($mobiile7){echo 'checked';} ?>  >  <?php _e('<b>After Image</b> ') ?> <select id="Img1Nup" name="Img1Nup">
						<?php for ($i=1;$i<=50;$i++) { ?>
				...
				<br/>
				<script type="text/javascript">qam_deftcheckinfo();</script>
		</td>
	</tr>
	<tr valign="top">
	...
	<tr valign="top">
		...
		<td>
			<span><?php echo(__(
				'A link from your blog to <a href="https://pluginmarket.net" target="_blank">https://pluginmarket.net</a> would be appreciated.'
			)); ?></span>
		</td>
	</tr>
