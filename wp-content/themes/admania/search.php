...
?>
  <div class="admania_contentareainner admania_layout1contentareainner">
    <?php
		...
		elseif($admania_blog_layout == 'amblyt2') {
		 ...
		 ?>
	    <header class="admania_searchheader">
			<h1 class="admania_searchtitle">
			  <?php 
              printf( __( 'Search Results Found For : %s', 'admania' ), '<span>"' . esc_html( get_search_query() ) . '"</span>'); 
			  ?>		
			</h1>
	   </header>
	   <!-- .search-header -->
  ...
  if($admania_blog_layout == 'amblyt4') {
	  ...
	  if((admania_get_option('layt4_cnt_lstsdbr') != 1) || (admania_get_option('layt4_cnt_frstlaytlstsdbr') != 1)):
?>
